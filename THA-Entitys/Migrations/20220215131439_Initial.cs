        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyLicense = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Trainees_TypeOfTrainings_TypeOfTrainingId",
            ...
            migrationBuilder.CreateTable(
                name: "CompaniesRequestForTrainings",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TrainingPathName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Capacity = table.Column<int>(type: "int", nullable: false),
                    TrainingPeriodFrom = table.Column<DateTime>(type: "datetime2", nullable: false),
                    TrainingPeriodTo = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompaniesRequestForTrainings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CompaniesRequestForTrainings_Companies_CompanyId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Projects_Trainees_TraineeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompaniesRequestForTrainings_CompanyId",
                table: "CompaniesRequestForTrainings",
                column: "CompanyId");
